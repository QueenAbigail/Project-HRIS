...
export const employeeSchedules: EmployeeSchedule[] = [
  { employeeId: 'EMP001', employeeName: 'Michael Chen', initials: 'MC', shiftId: 'morning', locationId: 'HO', department: 'Field Security', position: 'Senior Guard' },
  { employeeId: 'EMP002', employeeName: 'Sarah Williams', initials: 'SW', shiftId: 'morning', locationId: 'PT-DT', department: 'Surveillance', position: 'CCTV Operator' },
  { employeeId: 'EMP003', employeeName: 'David Rodriguez', initials: 'DR', shiftId: 'morning', locationId: 'RM', department: 'Patrol', position: 'Patrol Lead' },
  { employeeId: 'EMP004', employeeName: 'Emily Johnson', initials: 'EJ', shiftId: 'day', locationId: 'HO', department: 'Administration', position: 'HR Coordinator' },
  { employeeId: 'EMP005', employeeName: 'James Wilson', initials: 'JW', shiftId: 'evening', locationId: 'RM', department: 'Field Security', position: 'Security Guard' },
  { employeeId: 'EMP006', employeeName: 'Robert Taylor', initials: 'RT', shiftId: 'morning', locationId: 'MB-CT', department: 'Patrol', position: 'Night Patrol' },
  { employeeId: 'EMP007', employeeName: 'Jessica Brown', initials: 'JB', shiftId: 'morning', locationId: 'CC-N', department: 'Surveillance', position: 'Control Room Lead' },
  { employeeId: 'EMP008', employeeName: 'Thomas Anderson', initials: 'TA', shiftId: 'morning', locationId: 'IP-W', department: 'Field Security', position: 'Security Guard' },
  { employeeId: 'EMP009', employeeName: 'Lisa Martinez', initials: 'LM', shiftId: 'evening', locationId: 'PT-DT', department: 'Surveillance', position: 'CCTV Operator' },
  { employeeId: 'EMP010', employeeName: 'Kevin Lee', initials: 'KL', shiftId: 'night', locationId: 'RM', department: 'Field Security', position: 'Night Patrol' },
  { employeeId: 'EMP011', employeeName: 'Amanda White', initials: 'AW', shiftId: 'morning', locationId: 'HO', department: 'Administration', position: 'Payroll Specialist' },
  { employeeId: 'EMP012', employeeName: 'Daniel Harris', initials: 'DH', shiftId: 'day', locationId: 'MB-CT', department: 'VIP Protection', position: 'VIP Protection' },
  { employeeId: 'EMP013', employeeName: 'Michelle Garcia', initials: 'MG', shiftId: 'morning', locationId: 'CC-N', department: 'Field Security', position: 'Security Guard' },
  { employeeId: 'EMP014', employeeName: 'Christopher Moore', initials: 'CM', shiftId: 'evening', locationId: 'IP-W', department: 'Patrol', position: 'Mobile Patrol' },
  { employeeId: 'EMP015', employeeName: 'Jennifer Clark', initials: 'JC', shiftId: 'morning', locationId: 'PT-DT', department: 'Field Security', position: 'Senior Guard' },
]
...
export function getLocationAttendanceStats(): LocationAttendanceStats[] {
  ...
  return locations.map(location => {
    ...
    return {
      ...
      attendanceRate: Math.round((baseData.present / baseData.totalStaff) * 100),
    }
  })
}
...
export function getEmployeesWithAttendance(): EmployeeWithAttendance[] {
