  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        {/* Hapus print:fixed & print:h-screen, ganti pakai print:static & print:transform-none */}
        <DialogContent className="!w-[1400px] !max-w-[1400px] !h-[700px] !max-h-[700px] bg-gray-100 !p-0 overflow-hidden rounded-lg shadow-xl print:static print:transform-none print:!w-full print:!max-w-full print:!h-auto print:!max-h-none print:bg-white print:rounded-none print:shadow-none print:overflow-visible">
          ...
          {/* White Paper Container - Reset print position ke relative biar browser gampang nyesuain skala kertas */}
          <div
            id="payslip-content"
            className="w-full h-full bg-white text-slate-900 p-8 flex flex-col overflow-hidden print:relative print:w-full print:h-auto print:p-0 print:m-0 print:overflow-visible"
          >
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
              ...
              <div className="flex-1 flex gap-8 py-4 border-b border-gray-300 overflow-hidden">
                {/* Earnings */}
                <div className="flex-1 border-r border-gray-300 pr-8 overflow-hidden">
          ...
          {/* Action Buttons */}
          <div className="print:hidden flex gap-2 justify-end mt-6 px-4 pb-4">
            <Button
              variant="outline"
              size="sm"
